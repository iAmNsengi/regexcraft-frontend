  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <p className="text-lg text-gray-600 mb-4">
        RegexCraft is a powerful utility class designed to simplify the process
        of building and managing regular expressions. With its fluent, chainable
        API, developers can easily create complex regex patterns without the
        hassle of manual string manipulation.
      </p>
      ...
      <p className="text-lg text-gray-600 mb-4">
        ...
        validation and testing. Eliezer is passionate about creating tools that
        enhance developer productivity and streamline workflows.
      </p>
      <h2 className="text-2xl font-semibold mt-8 mb-4">Why Use RegexCraft?</h2>
